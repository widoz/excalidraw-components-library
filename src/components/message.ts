...
export default function message(theme: Theme): ExcalidrawElement[] {
  ...
  // Incoming message.
  els.push(...inkCircle(f, { cx: R, cy: ROW1_Y + R, r: R, fill: color.muted }));
  els.push(...label(f, {
    x: R,
  ...
  els.push(...rule(f, { x: bubble1X + 20, y: ROW1_Y + 22, w: 180, stroke: color.ink }));
  els.push(...rule(f, { x: bubble1X + 20, y: ROW1_Y + 46, w: 130, stroke: color.ink }));
  ...
  els.push(...inkCircle(f, { cx: avatar2Cx, cy: row2Y + R, r: R, fill: color.accent }));
  els.push(...label(f, {
    x: avatar2Cx,
  ...
  els.push(...rule(f, { x: bubble2X + 20, y: row2Y + 16, w: 160, stroke: color.accentText }));
  els.push(...rule(f, { x: bubble2X + 20, y: row2Y + 36, w: 120, stroke: color.accentText }));
